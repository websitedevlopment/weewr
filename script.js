...
function lastmessage() {
    ...
    if (fScore.innerText >= 800) {
        existing.push(fScore.innerText);
        // let emoji = "&#128525";
...
function clickCounter()
       {
        let text = ""; 
        existing.forEach(myFunction);

document.getElementById("arrPrint").innerHTML = text;
 
function myFunction(item, index) {
  text += index + " :   " + item + "<br>"; 
}
        // document.getElementById("arrPrint").innerHTML = existing;
       }
function timed() {
    t = setInterval(() => {
